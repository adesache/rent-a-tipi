...
axelle = 'https://images.unsplash.com/photo-1519699047748-de8e457a634e?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80'
...
#gigi.avatar.key = "d4ro3f846920ahdjawphcwxf7wdu"
...
top = Tent.new(title: 'On the Top', capacity: 2, comfort_level: 2, description: 'King of the World', location: 'Grand Combin', price: 100)
...
soldier = Tent.new(title: 'Soldier', capacity: 1, comfort_level: 1, description: 'Rough and tough', location: 'Aiguille des Glaciers', price: 60)
